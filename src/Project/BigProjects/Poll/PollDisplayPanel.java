package Project.BigProjects.Poll; /**
...
public class PollDisplayPanel extends JPanel
{
  ...
  {
    return  String.valueOf("There are " + count1 + " votes for " + name1 +
            "There are " + count2 + " votes for "  + name2 +
            "There are " + count3 + " votes for "  + name3);
  }
  ...
  private void drawLegend(Graphics g, int x, int y, int r)
  {
    ...
    g.drawString( String.valueOf(count1) , x - r, y);
  ...
  {
    return (int) (((360.0 / total) * count) + 0.5);
  }
